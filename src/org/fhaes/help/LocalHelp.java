...
/**
 * Contains static strings for help tip displayed within FHAES. This keeps the help text in one place making it easier to keep
 * track and update.
 * 
 * @author pwb48
 * 
...
public class LocalHelp {
	...
	public static final String EVENT_TYPE = "Select whether to perform analyses on:<br/>"
			+ "  - only fire events (upper case letters in the input files);<br/>"
			+ "  - only other indicators (lower case letters);<br/>"
			+ "  - both fire events <i>and</i> other indicators.<br>"
			+ "Note that choosing one of the first two options may remove one or more of "
			+ "your input files from the analyses if they do not contain enough of the "
	...
	public static final String FIELD_UTM_EASTING = "<b>Warning Deprecated</b> UTM easting value for the site. "
			+ UTM_RUBBISH;
	public static final String FIELD_UTM_NORTHING = "<b>Warning Deprecated</b> UTM northing value for the site.  "
			+ UTM_RUBBISH;
	...
	public static final String FIELD_LATITUDE = "Latitude value for the location of this site.  "
			+ USE_DECIMAL_DEGREES;
	public static final String FIELD_LONGITUDE = "Longitude value for the location of this site.  "
			+ USE_DECIMAL_DEGREES;
