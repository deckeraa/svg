...
/**
 * A specialist version of JXTable used for listing Segments for fire history analysis
 * 
 * @author pwb48
 */
public class SegmentTable extends JXTable {
	...
	private void setYearBounds() {
		...
		getColumnModel().getColumn(1).setCellEditor(
				new IntegerEditor(earliestYear, latestYear));
	...
	static class YearFormatRenderer extends DefaultTableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable table,
			...
			Component item = super.getTableCellRendererComponent(table, value,
