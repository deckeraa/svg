...
public class FrameViewOutput extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		btnPrint.addActionListener(new Frame_OutputView_btnPrint_actionAdapter(
				this));
		btnClose.setText("Close");
		btnClose.addActionListener(new Frame_OutputView_btnClose_actionAdapter(
				this));
		TArea.setText("");
...
class PrintListingPainter implements Printable {
	...
	private Font fnt = new Font("Helvetica", Font.PLAIN, 13);
	...
	public int print(Graphics g, PageFormat pf, int pageIndex)
		...
		try {
			...
			// Title line
			g.drawString("File: " + fileName + ", page: " + (pageIndex + 1), x,
					y);
