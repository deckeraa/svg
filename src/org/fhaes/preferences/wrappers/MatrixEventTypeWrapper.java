...
public class MatrixEventTypeWrapper extends ItemWrapper {
	...
	public MatrixEventTypeWrapper(JComboBox cbo, PrefKey key,
			Object defaultValue, EventTypeToProcess[] values) {
	...
	private final static EventTypeToProcess[] OPTIONS = EventTypeToProcess
			.values();
