...
public class NoDataLabelWrapper extends ItemWrapper<NoDataLabel> {
	...
	public NoDataLabelWrapper(JComboBox cbo, PrefKey key, Object defaultValue,
			NoDataLabel[] values) {
		super(key, defaultValue, NoDataLabel.class);
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private void initGeneric(JComboBox cbo, NoDataLabel[] values) {
	...
	private final static NoDataLabel[] OPTIONS = NoDataLabel.values();
