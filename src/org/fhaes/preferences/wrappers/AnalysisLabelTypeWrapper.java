...
public class AnalysisLabelTypeWrapper extends ItemWrapper<AnalysisLabelType> {
	...
	public AnalysisLabelTypeWrapper(JComboBox cbo, PrefKey key,
			Object defaultValue, AnalysisLabelType[] values) {
	...
	private final static AnalysisLabelType[] OPTIONS = AnalysisLabelType
			.values();
