...
/**
 * A small help icon which when clicked shows either a small popup box of text, or links to a webpage.
 * 
 * @author pbrewer
 */
public class HelpTipButton extends JLabel {
	...
	/**
	 * Constructor for the HelpTipButton. String parameter will be interpreted as a URL if possible, in which case clicking the
