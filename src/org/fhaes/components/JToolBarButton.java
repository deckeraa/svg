...
/**
 * An extension to JButton to style for use on a JToolBar. This set various behaviours like not focusable, tooltips, icon etc
 * 
 * @author pbrewer
...
public class JToolBarButton extends JButton {
	...
	/**
	 * This constructor takes the name of an iconFile and the text for the tooltip. Note the action for this button must be added
	 * manually.
	 * 
	 * @param iconFile
	 *            - File name within resources/image folder
	 * @param tooltip
	 */
