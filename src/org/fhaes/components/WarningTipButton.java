...
/**
 * A small warning icon which when clicked shows either a small popup box of text, or links to a webpage.
 * 
 * @author pbrewer
 * @see HelpTipButton
 */
public class WarningTipButton extends JLabel {
	...
	/**
	 * Constructor for the WarningTipButton. String parameter will be interpreted as a URL if possible, in which case clicking the
	 * button will open up a webpage. Otherwise, the string will be displayed as a HelpTip.
	 * 
	 * @param helpinfo
	 *            - Text string, or URL
	 */
