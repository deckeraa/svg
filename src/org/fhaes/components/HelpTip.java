...
/**
 * A simple post-it like modal dialog for showing tips to the user. Unlike a ToolTip the HelpTip is shown on request by the user
 * and must then be dismissed.
 * 
 */
public class HelpTip extends JDialog {
	 ...
	 * 
	 * @param text
	 *            - basic HTML text to display
	 * @param parent
	 *            - component that launched this dialog
	 */
	...
	/**
	 * Returns the preferred size to set a component at in order to render an html string. You can specify the size of one
	 * dimension.
	 * 
	 * @return dimension
	 */
