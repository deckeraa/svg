...
/**
 * This is a specialist type of JMenuItem which simply forces no icon when run from OSX
 * 
 * @author pbrewer
 * 
 */
public class FHAESMenuItem extends JMenuItem {
	...
	/**
	 * Get the icon associated with this MenuItem. If the current platform is OSX then the icon is null to fit with the standard
